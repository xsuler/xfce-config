...
values."
  (setq-default dotspacemacs-configuration-layers
                '((
                   ...
                   html
                   markdown
                   elixirhaskell :variables haskell-enable-hindent-style "johan-tibell")))
  (setq-default dotspacemacs-configuration-layers
                '(auto-completion
